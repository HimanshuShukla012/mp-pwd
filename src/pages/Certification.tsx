...
export default function Certification({ role }: { role: Role }) {
  ...
  const worksData = [
    {
      id: "WRK-245",
      desc: "Earthwork - Chainage 12+500 to 15+000",
    ...
    {
      id: "WRK-246",
      desc: "Subgrade Preparation - Tender 3",
    ...
    {
      id: "WRK-248",
      desc: "Drainage Works - Culvert 4-8",
  ...
  const handleCertification = (action: "approve" | "reject") => {
    alert(
      `Work ${action === "approve" ? "certified" : "rejected"} successfully!`,
    );
        ...
        {selectedWork && (
          <>
                ...
                <div>
                  ...
                  <span
                    style={{
                      ...
                      fontWeight: "700",
                      background:
                        selectedWork.type === "Milestone"
                          ? "#dbeafe"
                          : selectedWork.type === "Quality"
                            ? "#fef3c7"
                            : "#d1fae5",
                      color:
                        selectedWork.type === "Milestone"
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: "13px", color: "#78350f" }}>
                  Please conduct a field inspection before certification. Use
                  the checklist below.
                </div>
              </div>
            </div>
            ...
            <FormField
              ...
              type="select"
              options={["Excellent", "Good", "Satisfactory", "Below Standard"]}
              required
            />
