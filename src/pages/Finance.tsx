...
export default function Finance({ role }: { role: Role }) {
    ...
    switch (role) {
      case "PMU":
        return {
          ...
          subtitle:
            "Overall budget allocation, utilization, and fund management",
          canReallocate: true,
          canApproveUC: true,
          showAllPIUs: true,
        };
      case "PIU":
        return {
          ...
          subtitle: "Tender-wise budget tracking and utilization certificates",
          canReallocate: false,
          canApproveUC: false,
          showAllPIUs: false,
        };
  ...
  const dliReleases = [
    {
      dli: "DLI-1",
      description: "Road Length Improved",
      amount: "₹400 Cr",
      released: "₹400 Cr",
      status: "Released",
      date: "2025-12-15",
    ...
    <div style={{ padding: "32px", background: "#f8fafc", minHeight: "100vh" }}>
          ...
          >
            ...
            <div
              style={{
                ...
                alignItems: "baseline",
                gap: "8px",
                marginBottom: stat.subtitle ? "8px" : "0",
              }}
            >
              <div
                style={{
              ...
              {dliReleases.map((item, idx) => (
                <tr key={idx} style={{ borderBottom: "1px solid #f1f5f9" }}>
                  ...
                  <td
                    style={{
                      padding: "20px 16px",
                      color: item.status === "Released" ? "#10b981" : "#64748b",
                      fontSize: "15px",
                      fontWeight: "700",
                    }}
                  >
            ...
            <thead>
              <tr>
                {[
                  ...
                  "Period",
                  "Amount",
                  content.showAllPIUs ? "Submitted By" : null,
                  "Submitted On",
                  "Status",
                  "Action",
                ]
                  ...
                  <td style={{ padding: "20px 16px" }}>
                    <span
                      style={{
                        ...
                        fontWeight: "700",
                        background:
                          item.status === "Approved" ? "#d1fae5" : "#fef3c7",
                        color:
                          item.status === "Approved" ? "#065f46" : "#92400e",
                        textTransform: "uppercase",
                        letterSpacing: "0.5px",
                      }}
                    >
      ...
      <Modal
        ...
        footer={
          <>
            <ModalButton
              variant="secondary"
              onClick={() => setIsUploadUCOpen(false)}
            >
              Cancel
            </ModalButton>
      ...
      >
        ...
        >
          ...
          />
          <FormField
            label="Funds Received During Period (₹ Cr)"
            type="number"
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          <FormField
            label="Audited Statement of Expenditure"
            type="file"
            required
            helperText="PDF format, certified by CA"
          />
          <FormField
        ...
        >
          <AlertCircle
            size={20}
            style={{ color: "#92400e", flexShrink: 0, marginTop: "2px" }}
          />
          <div>
            <div
              style={{
            ...
            >
              ...
              <li>
                Opening Balance must match previous period's Closing Balance
              </li>
      ...
      <Modal
        ...
        footer={
          <>
            <ModalButton
              variant="secondary"
              onClick={() => setIsBudgetReallocateOpen(false)}
            >
              Cancel
            </ModalButton>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: "13px", color: "#1e3a8a" }}>
            Reallocation between budget heads requires approval from lender and
            must not exceed 10% of category allocation without prior consent.
          </div>
        </div>
        ...
        />
        <FormField
          label="Amount to Transfer (₹ Cr)"
          type="number"
          placeholder="e.g., 500"
          required
        />
        <FormField
          label="Available Balance in Source (₹ Cr)"
          value="5,000"
          disabled
        />
        ...
        <FormField
          label="Justification for Reallocation"
          type="textarea"
          rows={4}
          required
        ...
        <FormField
          label="Expected Impact on Program Timeline"
          type="textarea"
          rows={2}
        />
      </Modal>
        ...
        footer={
          ...
          selectedItem?.status === "Pending Approval" ? (
            <>
              <ModalButton
                variant="danger"
                onClick={() => handleApproveUC("reject")}
              >
                ✗ Reject UC
              </ModalButton>
              <ModalButton
                variant="success"
                onClick={() => handleApproveUC("approve")}
              >
                ✓ Approve UC
              </ModalButton>
            </>
