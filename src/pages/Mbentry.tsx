...
export default function MBEntry({ role }: { role: Role }) {
  ...
  const boqItems = [
    ...
    {
      itemNo: "102.3",
      description: "Subgrade Preparation and Compaction",
      unit: "sqm",
      rate: "₹85",
    },
    {
      itemNo: "201.5",
      description: "Granular Sub-base (GSB) 150mm thick",
      unit: "cum",
      rate: "₹1,850",
    },
    {
      itemNo: "202.8",
      description: "Wet Mix Macadam (WMM) 250mm thick",
      unit: "cum",
      rate: "₹2,450",
    },
    {
      itemNo: "301.2",
      description: "Dense Bituminous Macadam (DBM) 75mm",
      unit: "sqm",
      rate: "₹385",
    },
    {
      itemNo: "302.4",
      description: "Bituminous Concrete (BC) 40mm",
      unit: "sqm",
      rate: "₹295",
    },
    {
      itemNo: "401.1",
      description: "RCC M-30 for culverts",
      unit: "cum",
      rate: "₹8,500",
    },
    {
    ...
    <div style={{ padding: "32px", background: "#f8fafc", minHeight: "100vh" }}>
                  ...
                  <td style={{ padding: "20px 16px" }}>
                    <span
                      style={{
                        ...
                        fontWeight: "700",
                        background:
                          entry.status === "Verified by AE"
                            ? "#d1fae5"
                            : entry.status === "Submitted for Verification"
                              ? "#dbeafe"
                              : entry.status === "Returned for Correction"
                                ? "#fee2e2"
                                : "#fef3c7",
                        color:
                          entry.status === "Verified by AE"
      ...
      >
        ...
        <FormField
          ...
          type="select"
          options={[
            "PKG-001: Indore-Bhopal Corridor",
            "PKG-004: Jabalpur-Rewa Highway",
          ]}
          required
        />
        ...
        <FormField
          ...
          placeholder="e.g., CH 12+500 to 13+000"
          required
        />
        ...
        >
          ...
          <div>
            ...
            >
              <li>
                All measurements must be taken in presence of AE or authorized
                representative
              </li>
              <li>
                Record exact dimensions with precision up to 2 decimal places
              </li>
      ...
      >
        <FormField
          ...
          type="select"
          options={boqItems.map(
            (item) => `${item.itemNo} - ${item.description} (${item.unit})`,
          )}
          required
        />
        ...
        >
          ...
          >
            <div>
              Unit: <strong>cum</strong>
            </div>
            <div>
              Rate: <strong>₹245 per cum</strong>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div
            style={{ fontSize: "24px", fontWeight: "800", color: "#10b981" }}
          >
            0.00 cum
          </div>
