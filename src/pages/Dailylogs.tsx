  ...
  return (
    <div style={{ padding: "32px", background: "#f8fafc", minHeight: "100vh" }}>
                  ...
                  <td style={{ padding: "20px 16px" }}>
                    <span
                      style={{
                        ...
                        fontWeight: "700",
                        background:
                          log.workProgress === "Excellent"
                            ? "#d1fae5"
                            : log.workProgress === "Good"
                              ? "#dbeafe"
                              : log.workProgress === "Delayed"
                                ? "#fee2e2"
                                : "#fef3c7",
                        color:
                          log.workProgress === "Excellent"
                  ...
                  <td style={{ padding: "20px 16px" }}>
                    <span
                      style={{
                        ...
                        fontWeight: "700",
                        background:
                          log.status === "Submitted" ? "#dbeafe" : "#fef3c7",
                        color:
                          log.status === "Submitted" ? "#1e40af" : "#92400e",
                        textTransform: "uppercase",
                        letterSpacing: "0.5px",
                      }}
                    >
      ...
      <Modal
        ...
        footer={
          <>
            <ModalButton
              variant="secondary"
              onClick={() => setIsCreateLogOpen(false)}
            >
              Cancel
            </ModalButton>
      ...
      >
        ...
        >
          ...
          >
            ...
            <span
              style={{ fontSize: "20px", fontWeight: "800", color: "#f59e0b" }}
            >
              8
            </span>
          </div>
        ...
        {/* Issues & Delays */}
        <FormField
          label="Any Issues / Delays / Safety Incidents"
          type="textarea"
          rows={3}
      ...
      <Modal
        ...
        title={
          selectedLog?.status === "Draft" ? "Edit Daily Log" : "View Daily Log"
        }
        width="900px"
        footer={
        ...
        {selectedLog && (
          <>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              >
                Excavation work completed for 250 meters stretch. Total 2,450
                cum earthwork excavated and transported to designated dumping
                yard. Subgrade prepared and compacted for 180 meters. All work
              ...
              <div style={{ marginTop: "12px" }}>
                ...
                <span
                  style={{
                    ...
                    fontWeight: "700",
                    background:
                      selectedLog.workProgress === "Excellent"
                        ? "#d1fae5"
                        : selectedLog.workProgress === "Good"
                          ? "#dbeafe"
                          : "#fee2e2",
                    color:
                      selectedLog.workProgress === "Excellent"
            ...
            {selectedLog.remarks && (
              <div
                style={{
                  padding: "16px",
                  background:
                    selectedLog.workProgress === "Delayed"
                      ? "#fef2f2"
                      : "#f0f9ff",
                  borderRadius: "12px",
                  border:
