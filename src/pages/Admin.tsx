...
export default function Admin({ role }: { role: Role }) {
  ...
  const auditLogs = [
    {
      timestamp: "2026-01-30 18:20",
      user: "Amit Singh (JE)",
      action: "Created MB Entry",
      details: "MB-2024-158",
      ipAddress: "10.20.30.40",
    },
    {
      timestamp: "2026-01-30 17:30",
      user: "Rajesh Kumar (AE)",
      action: "Approved Progress Report",
      details: "PKG-001 Jan 2026",
      ipAddress: "10.20.30.35",
    },
    {
      timestamp: "2026-01-30 16:45",
      user: "ABC Constructions",
      action: "Submitted Bill",
      details: "Bill No. 18 - ₹85 Cr",
    ...
    },
    {
      ...
      details: "USR-006 - New JE",
      ipAddress: "10.20.30.10",
    },
    {
      timestamp: "2026-01-30 14:30",
      user: "Dr. Sharma (Auth Eng)",
      action: "Conducted Inspection",
      details: "INS-2024-247",
  ...
  return (
    <div style={{ padding: "32px", background: "#f8fafc", minHeight: "100vh" }}>
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              borderBottom:
                idx === 0 ? "3px solid #6366f1" : "3px solid transparent",
              fontSize: "14px",
                    ...
                    <div style={{ display: "flex", gap: "8px" }}>
                      ...
                      <button
                        ...
                        style={{
                          padding: "6px 12px",
                          background:
                            user.status === "Active" ? "#fee2e2" : "#d1fae5",
                          color:
                            user.status === "Active" ? "#991b1b" : "#065f46",
                          border: "none",
                          borderRadius: "8px",
                          fontSize: "12px",
                          fontWeight: "600",
      ...
      >
        ...
        <FormField
          label="Employee ID / Contractor License No."
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: "13px", color: "#1e3a8a" }}>
              A temporary password will be sent to the user's email. User must
      ...
      <Modal
        ...
        footer={
          <>
            <ModalButton
              variant="secondary"
              onClick={() => setIsCreatePIUOpen(false)}
            >
              Cancel
            </ModalButton>
      ...
      >
        ...
        <FormField
          label="PIU Name"
          placeholder="e.g., PIU - Western Region"
          required
        />
        <FormField
        ...
        />
        <FormField
          label="PIU Head / Executive Engineer"
        ...
        <FormField
          label="Contact Email"
          type="email"
          placeholder="piu.west@mpwd.gov.in"
          required
        />
        <FormField
          label="Contact Phone"
