...
export default function MyTenders({ role }: { role: Role }) {
  ...
  // Contractor's Assigned Tenders
  const assignedTenders = [
    {
      TenderNo: "PKG-001",
      projectName: "Indore-Bhopal Corridor",
      TenderName: "Tender 1: CH 0 to 25 km",
    ...
    },
    {
      ...
      TenderName: "Tender 4: CH 50 to 70 km",
    ...
    },
    {
      ...
      TenderName: "Tender 7: Bypass Section A",
  ...
  const recentActivities = [
    {
      date: "2026-01-30",
      activity: "Progress report submitted for PKG-001",
      status: "Pending Approval",
      TenderNo: "PKG-001",
    },
    {
      date: "2026-01-28",
      activity: "Bill submitted for ₹85 Cr (PKG-004)",
      status: "Under Review",
      TenderNo: "PKG-004",
    },
    {
      date: "2026-01-25",
      activity: "Payment received ₹120 Cr (PKG-001)",
      status: "Completed",
      TenderNo: "PKG-001",
    },
    {
      date: "2026-01-22",
      activity: "Quality test approved (PKG-007)",
      status: "Completed",
      TenderNo: "PKG-007",
    },
    {
      date: "2026-01-20",
      activity: "Extension request submitted (PKG-004)",
      status: "Pending Approval",
      TenderNo: "PKG-004",
    },
  ];
  ...
  const pendingApprovals = [
    {
      item: "Physical Progress Report - January 2026",
      TenderNo: "PKG-001",
      submittedOn: "2026-01-30",
      status: "Pending AE Approval",
    },
    {
      item: "Running Bill No. 18 - ₹85 Cr",
      TenderNo: "PKG-004",
      submittedOn: "2026-01-28",
      status: "Pending PIU Review",
    },
    {
      item: "Material Approval - Bitumen VG-30",
      TenderNo: "PKG-001",
      submittedOn: "2026-01-27",
      status: "Pending AE Approval",
    },
    {
      item: "Extension Request - 60 days",
      TenderNo: "PKG-004",
      submittedOn: "2026-01-20",
      status: "Pending PIU Approval",
    },
  ];

  // Work Orders by Tender
  const workOrders = {
    "PKG-001": [
      {
        woNo: "WO-001-A",
        description: "Earthwork & Land Development",
        value: "₹850 Cr",
        progress: 85,
        status: "Active",
      },
      {
        woNo: "WO-001-B",
        description: "Pavement & Surfacing",
        value: "₹950 Cr",
        progress: 68,
        status: "Active",
      },
  ...
  return (
    <div style={{ padding: "32px", background: "#f8fafc", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          <div>
            ...
            >
              Track your assigned Tenders, progress, and payments
            </p>
          </div>
          <div
            style={{
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: "100%",
                        background:
                          pkg.physicalProgress >= 80
                            ? "#10b981"
                            : pkg.physicalProgress >= 60
                              ? "#3b82f6"
                              : "#f59e0b",
                        borderRadius: "4px",
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: "100%",
                        background:
                          pkg.financialProgress >= 80
                            ? "#10b981"
                            : pkg.financialProgress >= 60
                              ? "#8b5cf6"
                              : "#f59e0b",
                        borderRadius: "4px",
                        transition: "width 0.5s ease",
                ...
                <div>
                  ...
                  <div
                    style={{
                      fontSize: "16px",
                      fontWeight: "700",
                      color: pkg.daysRemaining > 0 ? "#10b981" : "#ef4444",
                    }}
                  >
                ...
                <div>
                  ...
                  <span
                    style={{
                      ...
                      fontWeight: "700",
                      background:
                        pkg.performanceRating === "Excellent"
                          ? "#d1fae5"
                          : pkg.performanceRating === "Good"
                            ? "#dbeafe"
                            : "#fef3c7",
                      color:
                        pkg.performanceRating === "Excellent"
      ...
      <Modal
        isOpen={isViewTenderOpen}
        onClose={() => {
          setIsViewTenderOpen(false);
          setSelectedTender(null);
        }}
        ...
        {selectedTender && (
          <>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              >
                {workOrders[
                  selectedTender.TenderNo as keyof typeof workOrders
                ]?.map((wo, idx) => (
                  <div
                    key={idx}
                    style={{
                      ...
                      <div style={{ textAlign: "right" }}>
                        ...
                        <span
                          style={{
                            ...
                            fontWeight: "600",
                            color:
                              wo.status === "Active" ? "#10b981" : "#64748b",
                          }}
                        >
                          {wo.status}
                        </span>
        ...
        {selectedTender && (
          <>
            ...
            >
              ...
              >
                Tender: {selectedTender.TenderNo}
              </div>
              <div
                style={{
                  fontSize: "15px",
            ...
            <div style={{ marginTop: "20px" }}>
              ...
              />
              <FormField
                label="Measurement Book Extracts"
                type="file"
                required
              />
            ...
            <FormField
              label="Remarks / Challenges Faced"
              type="textarea"
              rows={3}
